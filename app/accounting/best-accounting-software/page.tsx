...
export default function BestAccountingSoftwarePage() {
  const useCaseEditorialItems = resolveBestOfUseCaseEditorials("accounting software", USE_CASE_LINKS);
  ...
  return (
    <div className="min-h-screen bg-background">
      <main>
        ...
        <RoundupTopPicksSummary picks={TOP_PICKS} routes={accountingPickRoutes} />
        ...
        <section id="best-accounting-picks" className="scroll-mt-section border-b border-stone-200/80 bg-white py-8 sm:py-11">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <RoundupSoftwarePicksSection picks={TOP_PICKS} routes={accountingPickRoutes} />
          </div>
        </section>
        ...
        <BestOfUseCaseEditorialSection
          headingCategoryLabel="accounting software"
