            ...
            <article className="min-w-0 lg:col-span-8">
              <div className="max-w-[720px]">
                ...
                <section className="pb-6 border-b border-neutral-200/60">
                  ...
                  <p className="mt-3 text-[#57534E] text-base leading-relaxed max-w-3xl">See how freelancers log billable hours, track projects, and invoice clients using time tracking tools.</p>
