...
export default function TimeTrackingGuidesPage() {
  return (
    <div className="min-h-screen bg-background">
      <main>
        ...
        <section className="bg-background">
          <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 sm:py-10 lg:px-8 lg:py-12">
            ...
            <h1 className="text-[#1A2D48] text-3xl font-bold leading-tight tracking-tight sm:text-4xl lg:text-5xl">
              Time Tracking Software Guides
            </h1>
            <p className="mt-3 text-[#57534E] text-base leading-relaxed max-w-3xl">
              Learn how time tracking software works, how to track billable hours, and how to choose the right tool for
              freelancers, agencies, and remote teams.
            </p>
            <GuideLastUpdated date="March 8, 2026" />
            <p className="mt-5 text-[#57534E] text-base leading-relaxed max-w-3xl">
              These guides help business owners and teams understand time tracking, from simple timers to tools with reporting
              and monitoring. Explore our{" "}
              <Link
                href="/time-tracking"
        ...
        {/* Guides grid */}
        <section
          id="time-tracking-guides"
          className="scroll-mt-section border-b border-stone-200/80 bg-white py-8 sm:py-11"
        >
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <SectionTitle sub="Educational guides on how time tracking software works, how to track billable hours, and how to compare tools.">
              Time Tracking Guides
            </SectionTitle>
            <div className="mt-4 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
              {TIME_TRACKING_GUIDES.map((guide) => (
...
export function generateMetadata() {
  return {
    title: "Time Tracking Software Guides | BeltStack",
    description:
      "Learn how time tracking software works, how to track billable hours, and how to choose the right time tracking tool for your business.",
  };
}
