...
export default function HelpdeskGuidesPage() {
  return (
        ...
        <section className="bg-[#F8FAFC]">
          <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 sm:py-10 lg:px-8 lg:py-12">
            ...
            <h1 className="text-[#1A2D48] text-3xl font-bold leading-tight tracking-tight sm:text-4xl lg:text-5xl">
              Helpdesk Software Guides
            </h1>
            <p className="mt-3 text-[#6E6E6E] text-base leading-relaxed max-w-3xl">
              These guides help businesses understand helpdesk platforms, compare ticketing tools, and choose the right software for small businesses, startups, ecommerce brands, SaaS teams, and growing support organizations.
            </p>
            <GuideLastUpdated date="March 13, 2026" />
            <p className="mt-5 text-[#6E6E6E] text-base leading-relaxed max-w-3xl">
              Whether you need a simple shared inbox or a full helpdesk with automation and reporting, these guides cover features, pricing, and how to evaluate options. You can also explore our{" "}
              ...
              to evaluate tools and find the best fit.
            </p>
          </div>
        </section>

        <section id="helpdesk-guides" className="scroll-mt-section border-b border-neutral-200/70 bg-white py-8 sm:py-11">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <SectionTitle sub="Educational guides on how helpdesk software works, who it's for, and how to choose a platform.">
              Helpdesk Guides
            </SectionTitle>
            <div className="mt-4 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
              {HELPDESK_GUIDES.map((guide) => (
                <GuideCard
                  key={guide.href}
                  title={guide.title}
                  href={guide.href}
...
export function generateMetadata() {
  return {
    title: "Helpdesk Software Guides | BeltStack",
    description:
      "Learn how helpdesk software works, who it's for, and how to choose the right platform for small businesses, startups, ecommerce, and SaaS support teams.",
  };
}
