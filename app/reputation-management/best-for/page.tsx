...
const LINKS = [
  {
    label: "Best reputation management software overall",
  ...
  ...BEST_FOR_BY_TRADE.map((item) => ({
    label: item.label,
    href: item.href,
    description: `Reputation software picks and guidance for ${item.label.toLowerCase()}.`,
  })),
];
        ...
        <section className="bg-background">
          <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 sm:py-10 lg:px-8 lg:py-12">
            ...
            <p className="mt-3 text-[#57534E] text-base leading-relaxed max-w-3xl">
              Scenario-based picks for contractors, home services, and local SMB operators managing review growth and response quality.
            </p>
          </div>
        </section>
        <section className="border-b border-stone-200/80 bg-white py-8 sm:py-11">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <p className="mt-6 text-sm text-[#57534E]">
              <Link href={getReputationManagementBestForUrl("contractors")} className="font-semibold text-[#10B981] hover:underline">Best for contractors</Link>
              {" · "}
