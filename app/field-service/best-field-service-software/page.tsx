...
import { getFieldServiceCompareUrl } from "@/lib/routes";
      ...
      <main>
        ...
        <section className="bg-[#F8FAFC]">
          <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 sm:py-10 lg:px-8 lg:py-12">
            ...
            <div className="mt-5">
              <a href="#best-field-service-picks" className={btnPrimary}>
                Jump to picks
              </a>
            </div>
          </div>
                ...
                >
                  ...
                  <div className="mt-4 flex flex-wrap items-center gap-4 border-t border-slate-200 pt-4">
                    ...
                    {pick.compareSlugs.length > 0 && (
                      <Link
                        href={getFieldServiceCompareUrl(pick.compareSlugs[0])}
