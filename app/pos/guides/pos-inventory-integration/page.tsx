              ...
              <div className="max-w-[720px]">
                ...
                <section className="pt-8 pb-8">
                  <div className="max-w-[720px] space-y-4 text-[15px] leading-relaxed text-neutral-700">
                    ...
                    <p>
                      This guide explains how POS–inventory integration works, when to use built-in POS inventory vs a separate system, and how it connects to the broader stack (e.g. <Link href="/accounting" className={linkGreen}>accounting</Link>). POS tools like <Link href={getPosReviewUrl("lightspeed-pos")} className={linkGreen}>Lightspeed</Link>, <Link href={getPosReviewUrl("square-pos")} className={linkGreen}>Square</Link>, and <Link href={getPosReviewUrl("shopify-pos")} className={linkGreen}>Shopify POS</Link> each handle inventory differently; we’ll point to where integration matters most.
                    </p>
                  </div>
                </section>
