              ...
              <div className="max-w-[720px]">
                ...
                <section className="pt-8 pb-8">
                  <div className="max-w-[720px] space-y-4 text-[15px] leading-relaxed text-neutral-700">
                    <p>
                      POS pricing is rarely a single number. You often see a combination of software (monthly or free), hardware (one-time or bundled), and payment processing (per transaction). Some providers quote everything together; others break out software, hardware, and processing. This guide explains common models—subscription, transaction fees, hardware—so you can compare <Link href={getPosReviewUrl("square-pos")} className={linkGreen}>Square</Link>, <Link href={getPosReviewUrl("clover-pos")} className={linkGreen}>Clover</Link>, <Link href={getPosReviewUrl("lightspeed-pos")} className={linkGreen}>Lightspeed</Link>, <Link href={getPosReviewUrl("toast-pos")} className={linkGreen}>Toast</Link>, and others on a level playing field.
                    </p>
                    <p>
                      For a shortlist by use case, see our <Link href="/pos/best-pos-software" className={linkGreen}>best POS software</Link> roundup, <Link href="/pos/best-for/small-business" className={linkGreen}>best POS for small business</Link>, and <Link href="/pos/compare" className={linkGreen}>comparisons</Link> like <Link href={getPosCompareUrl("square-pos-vs-clover-pos")} className={linkGreen}>Square vs Clover</Link>.
                    </p>
                  </div>
                </section>
