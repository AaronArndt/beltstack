              ...
              <div className="max-w-[720px]">
                ...
                <section className="pt-8 pb-8">
                  <div className="max-w-[720px] space-y-4 text-[15px] leading-relaxed text-neutral-700">
                    <p>
                      Choosing a POS can feel overwhelming: there are general-purpose systems like <Link href={getPosReviewUrl("square-pos")} className={linkGreen}>Square</Link> and <Link href={getPosReviewUrl("clover-pos")} className={linkGreen}>Clover</Link>, retail-focused tools like <Link href={getPosReviewUrl("lightspeed-pos")} className={linkGreen}>Lightspeed</Link> and <Link href={getPosReviewUrl("vend-pos")} className={linkGreen}>Vend</Link>, restaurant systems like <Link href={getPosReviewUrl("toast-pos")} className={linkGreen}>Toast</Link> and <Link href={getPosReviewUrl("touchbistro")} className={linkGreen}>TouchBistro</Link>, and ecommerce-unified options like <Link href={getPosReviewUrl("shopify-pos")} className={linkGreen}>Shopify POS</Link>. This guide gives you a framework to match your business type, scale, and must-haves to the right category and then narrow to a shortlist.
                    </p>
                    <p>
