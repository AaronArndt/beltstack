              ...
              <div className="max-w-[720px]">
                ...
                <section className="pt-8 pb-8">
                  <div className="max-w-[720px] space-y-4 text-[15px] leading-relaxed text-neutral-700">
                    ...
                    <p>
                      This guide explains how unified online-and-in-store POS works and when it’s worth it. For comparisons, see <Link href={getPosCompareUrl("square-pos-vs-shopify-pos")} className={linkGreen}>Square vs Shopify POS</Link> and <Link href={getPosCompareUrl("shopify-pos-vs-lightspeed-pos")} className={linkGreen}>Shopify POS vs Lightspeed</Link>; for a shortlist, our <Link href="/pos/best-pos-software" className={linkGreen}>best POS software</Link> roundup and <Link href="/pos/best-for/ecommerce" className={linkGreen}>best POS for ecommerce</Link>.
                    </p>
                  </div>
                </section>
