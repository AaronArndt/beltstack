...
export default function BestPosSoftwarePage() {
  const useCaseEditorialItems = resolveBestOfUseCaseEditorials("POS software", USE_CASE_LINKS);
  ...
  return (
    <div className="min-h-screen bg-background">
      <main>
        ...
        <RoundupTopPicksSummary picks={TOP_PICKS} routes={posPickRoutes} />
        ...
        >
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <RoundupSoftwarePicksSection picks={TOP_PICKS} routes={posPickRoutes} />
          </div>
        </section>
