...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  if (!data) {
    return {
      title: "HR Software Comparison",
      description: "Compare HR software side by side.",
    };
  }
  ...
  return {
    ...
    description: `Compare ${productA} vs ${productB} for HR software: features, pricing, use cases, and our verdict on who each tool fits best.`,
  };
}
