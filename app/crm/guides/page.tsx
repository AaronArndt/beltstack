  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC]">
      <main>
        ...
        <section className="bg-[#F8FAFC]">
          <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 sm:py-10 lg:px-8 lg:py-12">
            ...
            <p className="mt-5 text-[#6E6E6E] text-base leading-relaxed max-w-3xl">
              These guides help small businesses, startups, and sales teams understand CRM software, key features, pricing, and how to compare platforms. You can also explore our{" "}
              ...
              , and{" "}
              <Link href="/crm/best-crm-software" className="font-semibold text-[#10B981] hover:underline focus:outline-none focus-visible:ring-2 focus-visible:ring-[#10B981] rounded">
                best CRM software
              </Link>{" "}
        ...
        {/* ——— CRM Guides ——— */}
        <section id="crm-guides" className="scroll-mt-section border-b border-neutral-200/70 bg-white py-8 sm:py-11">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <SectionTitle sub="Educational guides on how CRM works, who it's for, and how to choose a platform.">
              CRM Guides
            </SectionTitle>
            <div className="mt-4 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
              {CRM_GUIDES.map((guide) => (
                <GuideCard
                  key={guide.href}
                  title={guide.title}
                  href={guide.href}
...
export function generateMetadata() {
  return {
    title: "CRM Software Guides | BeltStack",
    description:
      "Learn what CRM software is, who uses it, and how to choose the right CRM for your business, sales team, or startup.",
  };
}
