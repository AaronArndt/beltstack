...
export function generateMetadata() {
  return {
    ...
    description:
      "Compare the best CRM software for startups: HubSpot, Pipedrive, Zoho CRM, Monday CRM. Founder-led sales, fast setup, flexibility, and scaling without overbuying.",
  };
}
