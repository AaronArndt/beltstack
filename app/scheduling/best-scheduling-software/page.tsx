...
import { getSchedulingAlternativeUrl, getSchedulingCompareUrl } from "@/lib/routes";
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC]">
      <main>
            ...
            <div className="mt-6 space-y-10">
              {TOP_PICKS.map((pick) => (
                <SoftwarePickCard
                  ...
                  pros={pick.pros}
                  cons={pick.cons}
                  alternativesUrl={getSchedulingAlternativeUrl(pick.slug)}
                  comparisonLinks={pick.compareSlugs.slice(0, 3).map((slug) => ({
                    href: getSchedulingCompareUrl(slug),
        ...
        >
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <SectionTitle sub="Find scheduling tools that fit your situation.">
