  ...
  return (
    <div className="min-h-screen bg-background">
      <main>
        ...
        <RoundupTopPicksSummary picks={TOP_PICKS} routes={projectManagementPickRoutes} />
        ...
        <section id="best-project-management-picks" className="scroll-mt-section border-b border-stone-200/80 bg-white py-8 sm:py-11">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <RoundupSoftwarePicksSection picks={TOP_PICKS} routes={projectManagementPickRoutes} />
          </div>
        </section>
