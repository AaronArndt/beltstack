...
const DEFAULT_RELATED_FIELD_SERVICE_RESOURCES: RelatedFieldServiceResourceItem[] = [
  ...
  { label: "What is field service software? (guide)", href: "/field-service/guides/what-is-field-service-software" },
  { label: "How field service software works (guide)", href: "/field-service/guides/how-field-service-software-works" },
  { label: "How mobile field service apps work (guide)", href: "/field-service/guides/how-mobile-field-service-apps-work" },
  { label: "Common problems FSM solves (guide)", href: "/field-service/guides/common-problems-field-service-software-solves" },
