...
export const BEST_FOR_BY_TRADE: { label: string; href: string }[] = [
  ...
  { label: "Appliance repair businesses", href: getPaymentProcessingBestForUrl("appliance-repair") },
  { label: "Garage door companies", href: getPaymentProcessingBestForUrl("garage-door") },
  { label: "Locksmith businesses", href: getPaymentProcessingBestForUrl("locksmith") },
  { label: "Flooring contractors", href: getPaymentProcessingBestForUrl("flooring") },
  { label: "Fence & deck builders", href: getPaymentProcessingBestForUrl("fence-deck") },
  { label: "Glass & window installers", href: getPaymentProcessingBestForUrl("glass-window-installers") },
  { label: "Concrete contractors", href: getPaymentProcessingBestForUrl("concrete-contractors") },
  { label: "Excavation companies", href: getPaymentProcessingBestForUrl("excavation") },
  { label: "Auto repair shops", href: getPaymentProcessingBestForUrl("auto-repair") },
  { label: "Mobile mechanics", href: getPaymentProcessingBestForUrl("mobile-mechanics") },
  { label: "Cleaning franchises", href: getPaymentProcessingBestForUrl("cleaning-franchises") },
  { label: "Event services", href: getPaymentProcessingBestForUrl("event-services") },
  { label: "Home inspectors", href: getPaymentProcessingBestForUrl("home-inspectors") },
