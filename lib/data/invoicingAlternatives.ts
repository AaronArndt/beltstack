...
const QUICKBOOKS_ALTERNATIVES: AlternativesTopPick[] = [
  ...
  { slug: "zoho-invoice", name: "Zoho Invoice", logoSrc: "/Logos/zoho.jpeg", rating: "4.4", bestFor: "value", description: "Affordable invoicing with free tier and automation.", reviewHref: getInvoicingReviewUrl("zoho-invoice"), startingPrice: "Free tier", standoutFeature: "Value; automation" },
...
const WAVE_ALTERNATIVES: AlternativesTopPick[] = [
  ...
  { slug: "zoho-invoice", name: "Zoho Invoice", logoSrc: "/Logos/zoho.jpeg", rating: "4.4", bestFor: "value and free tier", description: "Free tier and affordable paid plans. Projects and automation.", reviewHref: getInvoicingReviewUrl("zoho-invoice"), compareHref: getInvoicingCompareUrl("wave-vs-zoho-invoice"), startingPrice: "Free tier", standoutFeature: "Value; automation" },
...
const zohoInvoicePage: AlternativesTemplateProps = {
  ...
  comparisonTableRows: buildTableRows(
    { slug: "zoho-invoice", name: "Zoho Invoice", logoSrc: "/Logos/zoho.jpeg", bestFor: "value and projects", startingPrice: "Free tier", standoutFeature: "Value; automation", reviewHref: getInvoicingReviewUrl("zoho-invoice") },
...
const XERO_ALTERNATIVES: AlternativesTopPick[] = [
  ...
  { slug: "zoho-invoice", name: "Zoho Invoice", logoSrc: "/Logos/zoho.jpeg", rating: "4.4", bestFor: "value", description: "Affordable with free tier and automation.", reviewHref: getInvoicingReviewUrl("zoho-invoice"), startingPrice: "Free tier", standoutFeature: "Value; automation" },
  { slug: "invoice-ninja", name: "Invoice Ninja", logoSrc: "/Logos/invoiceninja.jpeg", rating: "4.3", bestFor: "self-hosted", description: "Open-source and cloud options.", reviewHref: getInvoicingReviewUrl("invoice-ninja"), startingPrice: "Free / paid", standoutFeature: "Self-hosted option" },
];
...
const INVOICE_NINJA_ALTERNATIVES: AlternativesTopPick[] = [
  ...
  { slug: "zoho-invoice", name: "Zoho Invoice", logoSrc: "/Logos/zoho.jpeg", rating: "4.4", bestFor: "value", description: "Free tier and automation. Cloud-only.", reviewHref: getInvoicingReviewUrl("zoho-invoice"), startingPrice: "Free tier", standoutFeature: "Value; automation" },
  { slug: "quickbooks", name: "QuickBooks", logoSrc: "/Logos/quickbooks.png", rating: "4.6", bestFor: "QuickBooks ecosystem", description: "Full accounting plus invoicing.", reviewHref: getInvoicingReviewUrl("quickbooks"), startingPrice: "$30/mo", standoutFeature: "Full accounting" },
  { slug: "xero", name: "Xero", logoSrc: "/Logos/xero.png", rating: "4.5", bestFor: "accounting integration", description: "Cloud invoicing and accounting.", reviewHref: getInvoicingReviewUrl("xero"), startingPrice: "$15/mo", standoutFeature: "Accounting integration" },
];
...
const HONEYBOOK_ALTERNATIVES: AlternativesTopPick[] = [
  ...
  { slug: "zoho-invoice", name: "Zoho Invoice", logoSrc: "/Logos/zoho.jpeg", rating: "4.4", bestFor: "value", description: "Affordable invoicing with projects and client portal.", reviewHref: getInvoicingReviewUrl("zoho-invoice"), startingPrice: "Free tier", standoutFeature: "Value; automation" },
