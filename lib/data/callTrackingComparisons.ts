...
const entries: [string, ComparisonTemplateProps][] = [
  ...
  build(
    ...
    "Both can attribute an inbound call to a campaign. The real split is whether you need CallRail’s published-plan marketing stack—or Invoca’s quote-based system for classifying call outcomes, scoring agents, and sending those signals into ads and CRM at contact-center scale.",
    {
      ...
      researchNote:
        "Pricing and product details verified August 2026 from CallRail’s public pricing and plan-type documentation and Invoca’s pricing and llm-info pages. Invoca does not publish dollar prices; this page does not treat third-party estimates as facts. BeltStack has not installed either platform, routed calls, reviewed production transcripts, received an Invoca quote, or measured attribution accuracy.",
      ...
      pricingComparisonParagraphs: [
        "CallRail currently lists four packages on its pricing page: Lead Tracking, Lead Tracking Complete, Lead Conversion, and Lead Conversion Complete. CallRail’s own comparison copy states plans start at $55/month ($50 billed annually). Every listed plan includes 5 local numbers and 250 local minutes (the table notes additional fees may apply, and that local minutes include transcription). 25 SMS messages are listed as included after trial. Lead Tracking includes call and text attribution, recording and routing, transcription and analysis, and automation rules. Complete adds form tracking. Lead Conversion unlocks Premium Conversation Intelligence (summaries, sentiment, trend reports, automatic conversion tagging, coaching and conversion tools). Lead Conversion Complete combines forms plus Premium CI. Voice Assist is a separate product CallRail documents at $95/month including 50 answered calls, then $1 per additional call (calls under 15 seconds handled by Voice Assist do not count). Extra numbers, extra minutes, toll-free surcharges, and Premium CI analysis minutes appear as usage/activity charges. Confirm current extra-number and per-minute rates on CallRail’s pricing page—do not treat a competitor blog’s cents as the invoice. CallRail help: recording is in the base price; unlimited users and companies except HIPAA accounts; 14-day trial with all features.",
        "Invoca’s pricing page has no dollars. Pro / Enterprise / Elite are Get Your Quote. Invoca’s June 2026 llm-info page states quote-based subscription with annual contract terms; pricing varies by organization size, number count, and contract length. Published package shape: Pro includes 6,000 annual numbers and 5 custom Signals; Enterprise 12,000 numbers and 50 Signals plus enhanced digital capture, extra ad/social integrations, advanced IVR, SAML SSO, sandbox; Elite 18,000 numbers and 100 Signals plus PreSense, intelligent routing, SIP, affiliate suite. Signal AI, Quality Management, and PreSense are listed as add-ons (PreSense is included on Elite). Salesforce CRM and Adobe Experience Cloud are premium integrations. Separate Performance packages exist for pay-per-call. Implementation, support level, and volume overages are not public dollar lines—ask.",
