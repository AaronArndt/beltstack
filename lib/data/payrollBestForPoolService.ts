...
export const POOL_SERVICE_PAGE_PROPS = {
  title: "Best Payroll Software for Pool Service Businesses (2026)",
  subtitle:
    "Compare payroll software for pool service companies and teams managing W-2 technicians plus 1099 subcontractors.",
  useCase: "pool-service",
  categoryHref: "/payroll",
  categoryLabel: "Payroll",
  introParagraph:
    "Pool service businesses need payroll that handles W-2 route techs and office staff, 1099 subcontractors when you use them, and labor cost that ties to routes or jobs when you use QuickBooks. Our picks work for small and growing operations—from solo operators adding a helper to multi-crew companies that want an all-in-one platform or simple flat-rate payroll.",
  ...
  featuredProducts: [
    {
      slug: "gusto",
      name: "Gusto",
      badge: "Best overall for small pool service businesses",
      description:
    ...
    },
    {
      ...
      badge: "Best for pool service businesses using QuickBooks",
      description:
        "Payroll inside QuickBooks so labor cost flows into route or job costing. Ideal when you run invoicing and books in QuickBooks. Pay techs and 1099 subs in the same system; time tracking can tie hours to routes or jobs.",
      rating: "4.6",
      startingPrice: "$30/mo",
    ...
    },
    {
      slug: "adp",
      name: "ADP",
      badge: "Best for growing pool service teams",
      description:
  ...
  comparisonTableRows: [
    {
      ...
      name: "Gusto",
      logoSrc: "/Logos/gusto.jpeg",
      bestFor: "Best overall for small pool service",
      startingPrice: "$49/mo",
    ...
    },
    {
      ...
      name: "QuickBooks Payroll",
      logoSrc: "/Logos/quickbooks.png",
      bestFor: "Pool service using QuickBooks",
      startingPrice: "$30/mo",
      payrollTypes: "W-2, 1099",
      standoutFeature: "Labor cost in routes/jobs; job costing",
      reviewHref: getPayrollReviewUrl("quickbooks-payroll"),
    },
    {
      slug: "onpay",
    ...
    },
    {
      ...
      name: "ADP",
      logoSrc: "/Logos/adp.jpeg",
      bestFor: "Growing pool service teams",
      startingPrice: "Custom pricing",
  ...
  editorialGuidance: [
    ...
    {
      heading: "Seasonal staffing",
      body: "Pool service is often busier in warm months. Payroll software should make it easy to add and remove seasonal workers, run more frequent pay runs in peak season, and keep tax and compliance correct. Gusto and OnPay scale up and down without long-term contracts.",
    },
    {
      heading: "Ease of use for small operations",
      body: "Many pool service businesses have an owner or office manager running payroll. Choose software that's straightforward to set up and run—published pricing, no long sales cycle, and support when you need it. Gusto and OnPay are built for self-serve; QuickBooks Payroll fits if you already use QuickBooks; ADP offers dedicated support when you're ready to scale.",
    },
  ...
  faqItems: [
    {
      q: "What is the best payroll software for pool service businesses?",
      a: "Gusto is our top pick for most small pool service businesses: it handles W-2 route techs and 1099 subcontractors in one system, offers a contractor portal and automatic tax forms, and includes time tracking. QuickBooks Payroll is best if you already use QuickBooks and need labor cost in route or job costing. OnPay is a strong value option; ADP fits growing teams that want full-service support.",
    },
    {
    ...
    {
      q: "What payroll software works best with QuickBooks for pool service?",
      a: "QuickBooks Payroll runs inside QuickBooks, so labor cost from payroll posts directly to jobs—ideal for pool service route and job costing. If you run invoicing and books in QuickBooks, payroll in the same system keeps everything in one place. Gusto and OnPay integrate with QuickBooks but don't push labor cost to jobs the same way.",
    },
    {
      q: "How do I track tech time for payroll and route costing?",
      a: "Gusto has built-in time tracking that syncs to payroll. QuickBooks Payroll integrates with QuickBooks Time for time-by-job. OnPay integrates with various time clocks and apps. Choose a setup that gets tech hours into payroll without re-entry and, if you use job or route costing, allocates hours to the right routes or jobs.",
    },
    {
      q: "What payroll software is best for seasonal pool service staffing?",
      a: "Gusto and OnPay both work well for seasonal staffing: no long-term contracts, easy to add and remove workers, and unlimited pay runs so you can pay more often in peak season. QuickBooks Payroll fits if you're already in QuickBooks. All handle W-2 and 1099 so you can mix full-time route techs with seasonal or sub help.",
    },
  ] as BestForFaqItem[],
};
