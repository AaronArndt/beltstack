...
export const PLUMBING_PAGE_PROPS = {
  ...
  subtitle:
    "Compare payroll software for plumbing businesses, HVAC and trade companies, and teams managing W-2 technicians plus 1099 subcontractors.",
  useCase: "plumbing",
  categoryHref: "/payroll",
  categoryLabel: "Payroll",
  introParagraph:
    "Plumbing companies need payroll that handles W-2 technicians and office staff, 1099 subcontractors when you use them, and labor cost that ties to jobs or service calls when you use QuickBooks. Our picks work for small and growing operations—from those running books in QuickBooks to teams that want an all-in-one platform or simple flat-rate payroll.",
  ...
  featuredProducts: [
    {
      slug: "gusto",
      name: "Gusto",
      badge: "Best overall for small plumbing companies",
      description:
    ...
    },
    {
      ...
      badge: "Best for plumbing companies using QuickBooks",
      description:
    ...
    },
    {
      slug: "adp",
      name: "ADP",
      badge: "Best for growing plumbing teams",
      description:
  ...
  comparisonTableRows: [
    {
      ...
      name: "Gusto",
      logoSrc: "/Logos/gusto.jpeg",
      bestFor: "Best overall for small plumbing",
      startingPrice: "$49/mo",
    ...
    },
    {
      ...
      name: "QuickBooks Payroll",
      logoSrc: "/Logos/quickbooks.png",
      bestFor: "Plumbing using QuickBooks",
      startingPrice: "$30/mo",
      payrollTypes: "W-2, 1099",
    ...
    },
    {
      ...
      name: "ADP",
      logoSrc: "/Logos/adp.jpeg",
      bestFor: "Growing plumbing teams",
      startingPrice: "Custom pricing",
  ...
  editorialGuidance: [
    {
      ...
      body: "Plumbing companies often have W-2 techs and office staff plus 1099 subs for specialty or overflow work. Your payroll system should handle both in one place—correct withholding for W-2, no withholding for 1099, and the right tax forms (W-2 vs 1099-NEC) at year-end. Contractor self-service lets subs view pay stubs without extra admin.",
    },
    {
      heading: "Job and service-call costing",
      body: "Labor cost by job or service call is central to plumbing profitability. If you run your books in QuickBooks, payroll that posts labor to jobs (QuickBooks Payroll) keeps job costing accurate. Gusto and OnPay sync to QuickBooks but don't push cost to jobs the same way; they're still strong for running payroll and tracking who worked where.",
    },
    {
      heading: "Time tracking and payroll sync",
      body: "Tech time can be captured with mobile apps, time clocks, or manual entry. The best setup syncs hours into payroll so you're not re-entering data. Gusto has built-in time tracking; QuickBooks Payroll integrates with QuickBooks Time for time-by-job. Accurate hours support job costing and overtime compliance.",
    },
    {
  ...
  faqItems: [
    {
      q: "What is the best payroll software for plumbing companies?",
      a: "Gusto is our top pick for most small plumbing companies: it handles W-2 techs and 1099 subcontractors in one system, offers a contractor portal and automatic tax forms, and includes time tracking. QuickBooks Payroll is best if you already use QuickBooks and need labor cost in job costing. OnPay is a strong value option; ADP fits growing teams that want full-service support.",
    },
    {
    ...
    {
      q: "What payroll software works best with QuickBooks for plumbing?",
      a: "QuickBooks Payroll runs inside QuickBooks, so labor cost from payroll posts directly to jobs—ideal for plumbing job costing and service calls. If you run invoicing and books in QuickBooks, payroll in the same system keeps everything in one place. Gusto and OnPay integrate with QuickBooks but don't push labor cost to jobs the same way.",
    },
    {
