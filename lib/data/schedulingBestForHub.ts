...
import {
  APPLIANCE_REPAIR_SCHEDULING_BEST_FOR_PAGE_PROPS,
  AUTO_REPAIR_SCHEDULING_BEST_FOR_PAGE_PROPS,
  CLEANING_FRANCHISES_SCHEDULING_BEST_FOR_PAGE_PROPS,
  CONCRETE_CONTRACTORS_SCHEDULING_BEST_FOR_PAGE_PROPS,
  CONSTRUCTION_SCHEDULING_BEST_FOR_PAGE_PROPS,
  ELECTRICIANS_SCHEDULING_BEST_FOR_PAGE_PROPS,
  EVENT_SERVICES_SCHEDULING_BEST_FOR_PAGE_PROPS,
  EXCAVATION_SCHEDULING_BEST_FOR_PAGE_PROPS,
  FENCE_DECK_SCHEDULING_BEST_FOR_PAGE_PROPS,
  FLOORING_SCHEDULING_BEST_FOR_PAGE_PROPS,
  GARAGE_DOOR_SCHEDULING_BEST_FOR_PAGE_PROPS,
  GENERAL_CONTRACTORS_SCHEDULING_BEST_FOR_PAGE_PROPS,
  GLASS_WINDOW_INSTALLERS_SCHEDULING_BEST_FOR_PAGE_PROPS,
  HANDYMAN_SCHEDULING_BEST_FOR_PAGE_PROPS,
  HOME_INSPECTORS_SCHEDULING_BEST_FOR_PAGE_PROPS,
  HVAC_SCHEDULING_BEST_FOR_PAGE_PROPS,
  JUNK_REMOVAL_SCHEDULING_BEST_FOR_PAGE_PROPS,
  LANDSCAPING_SCHEDULING_BEST_FOR_PAGE_PROPS,
  LOCKSMITH_SCHEDULING_BEST_FOR_PAGE_PROPS,
  MOBILE_MECHANICS_SCHEDULING_BEST_FOR_PAGE_PROPS,
...
const SCHEDULING_BEST_FOR_PROPS_BY_SLUG: Record<string, BestForTemplateProps> = {
  ...
  "appliance-repair": APPLIANCE_REPAIR_SCHEDULING_BEST_FOR_PAGE_PROPS,
  "garage-door": GARAGE_DOOR_SCHEDULING_BEST_FOR_PAGE_PROPS,
  locksmith: LOCKSMITH_SCHEDULING_BEST_FOR_PAGE_PROPS,
  flooring: FLOORING_SCHEDULING_BEST_FOR_PAGE_PROPS,
  "fence-deck": FENCE_DECK_SCHEDULING_BEST_FOR_PAGE_PROPS,
  "glass-window-installers": GLASS_WINDOW_INSTALLERS_SCHEDULING_BEST_FOR_PAGE_PROPS,
  "concrete-contractors": CONCRETE_CONTRACTORS_SCHEDULING_BEST_FOR_PAGE_PROPS,
  excavation: EXCAVATION_SCHEDULING_BEST_FOR_PAGE_PROPS,
  "auto-repair": AUTO_REPAIR_SCHEDULING_BEST_FOR_PAGE_PROPS,
  "mobile-mechanics": MOBILE_MECHANICS_SCHEDULING_BEST_FOR_PAGE_PROPS,
  "cleaning-franchises": CLEANING_FRANCHISES_SCHEDULING_BEST_FOR_PAGE_PROPS,
  "event-services": EVENT_SERVICES_SCHEDULING_BEST_FOR_PAGE_PROPS,
