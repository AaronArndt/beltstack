...
export const POS_GUIDE_RELATED_ITEMS = [
  ...
  { label: "Clover POS Review", href: getPosReviewUrl("clover-pos") },
  { label: "Toast POS Review", href: getPosReviewUrl("toast-pos") },
  { label: "Vend POS Review", href: getPosReviewUrl("vend-pos") },
