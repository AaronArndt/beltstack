...
export const TOP_PICKS: BestLeadGenPick[] = [
  {
    ...
    pricingSummary:
      "No membership fee. Pay a lead price under exact lead prices and a weekly budget. Direct leads are charged when the customer reaches out. Confirm dispute rules in your market before scaling.",
  },
  {
    slug: "angi",
    name: "Angi",
  ...
  },
  {
    ...
    description: "Google Verified placements for local services searches with pay-per-lead billing in eligible categories.",
    rating: "4.5",
    ...
    standoutFeature: "High-intent Google visibility; Google Verified badge",
    editorialParagraph:
    ...
    pros: ["High-intent search traffic", "Google Verified badge", "Automated lead credits (US/Canada)"],
