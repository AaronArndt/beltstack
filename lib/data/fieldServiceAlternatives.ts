...
const HOUSECALL_PRO_ALTERNATIVES: AlternativesTopPick[] = [
  { slug: "jobber", name: "Jobber", logoSrc: LOGOS.jobber, rating: "4.6", bestFor: "overall", description: "All-in-one balance for contractors.", reviewHref: getFieldServiceReviewUrl("jobber"), compareHref: getFieldServiceCompareUrl("jobber-vs-housecall-pro"), startingPrice: "From $29/mo billed annually (Core, 1 user)", standoutFeature: "All-in-one; balance" },
...
const SERVICETITAN_ALTERNATIVES: AlternativesTopPick[] = [
  ...
  { slug: "jobber", name: "Jobber", logoSrc: LOGOS.jobber, rating: "4.6", bestFor: "contractors", description: "All-in-one for small to mid-size contractors.", reviewHref: getFieldServiceReviewUrl("jobber"), startingPrice: "From $29/mo billed annually (Core, 1 user)", standoutFeature: "All-in-one" },
...
const SERVICE_FUSION_ALTERNATIVES: AlternativesTopPick[] = [
  ...
  { slug: "jobber", name: "Jobber", logoSrc: LOGOS.jobber, rating: "4.6", bestFor: "contractors", description: "All-in-one for contractors.", reviewHref: getFieldServiceReviewUrl("jobber"), startingPrice: "From $29/mo billed annually (Core, 1 user)", standoutFeature: "All-in-one" },
...
const WORKIZ_ALTERNATIVES: AlternativesTopPick[] = [
  { slug: "jobber", name: "Jobber", logoSrc: LOGOS.jobber, rating: "4.6", bestFor: "overall", description: "All-in-one balance for contractors.", reviewHref: getFieldServiceReviewUrl("jobber"), compareHref: getFieldServiceCompareUrl("jobber-vs-workiz"), startingPrice: "From $29/mo billed annually (Core, 1 user)", standoutFeature: "All-in-one" },
...
const KICKSERV_ALTERNATIVES: AlternativesTopPick[] = [
  { slug: "jobber", name: "Jobber", logoSrc: LOGOS.jobber, rating: "4.6", bestFor: "overall", description: "All-in-one balance for contractors.", reviewHref: getFieldServiceReviewUrl("jobber"), compareHref: getFieldServiceCompareUrl("kickserv-vs-jobber"), startingPrice: "From $29/mo billed annually (Core, 1 user)", standoutFeature: "All-in-one" },
  { slug: "workiz", name: "Workiz", logoSrc: LOGOS.workiz, rating: "4.4", bestFor: "small teams", description: "Lower cost for small field teams.", reviewHref: getFieldServiceReviewUrl("workiz"), startingPrice: "From ~$29/mo", standoutFeature: "Small teams; value" },
  { slug: "housecall-pro", name: "Housecall Pro", logoSrc: LOGOS.housecallpro, rating: "4.5", bestFor: "home service", description: "Strong for home service pros.", reviewHref: getFieldServiceReviewUrl("housecall-pro"), startingPrice: "From ~$49/mo", standoutFeature: "Home service" },
  { slug: "servicem8", name: "ServiceM8", logoSrc: LOGOS.servicem8, rating: "4.3", bestFor: "mobile-first", description: "Mobile-first field service.", reviewHref: getFieldServiceReviewUrl("servicem8"), startingPrice: "From ~$29/mo", standoutFeature: "Mobile-first" },
...
const SERVICEM8_ALTERNATIVES: AlternativesTopPick[] = [
  { slug: "jobber", name: "Jobber", logoSrc: LOGOS.jobber, rating: "4.6", bestFor: "overall", description: "All-in-one balance for contractors.", reviewHref: getFieldServiceReviewUrl("jobber"), startingPrice: "From $29/mo billed annually (Core, 1 user)", standoutFeature: "All-in-one" },
  { slug: "workiz", name: "Workiz", logoSrc: LOGOS.workiz, rating: "4.4", bestFor: "small teams", description: "Lower cost for small field teams.", reviewHref: getFieldServiceReviewUrl("workiz"), startingPrice: "From ~$29/mo", standoutFeature: "Small teams" },
  { slug: "housecall-pro", name: "Housecall Pro", logoSrc: LOGOS.housecallpro, rating: "4.5", bestFor: "home service", description: "Strong for home service pros.", reviewHref: getFieldServiceReviewUrl("housecall-pro"), startingPrice: "From ~$49/mo", standoutFeature: "Home service" },
  { slug: "kickserv", name: "Kickserv", logoSrc: LOGOS.kickserv, rating: "4.3", bestFor: "small business", description: "Straightforward FSM for small businesses.", reviewHref: getFieldServiceReviewUrl("kickserv"), startingPrice: "From ~$55/mo", standoutFeature: "Small business" },
  { slug: "mhelpdesk", name: "mHelpDesk", logoSrc: LOGOS.mhelpdesk, rating: "4.2", bestFor: "contractors", description: "Contractors and technicians.", reviewHref: getFieldServiceReviewUrl("mhelpdesk"), startingPrice: "From ~$49/mo", standoutFeature: "Contractors" },
...
const FIELDEDGE_ALTERNATIVES: AlternativesTopPick[] = [
  ...
  { slug: "service-fusion", name: "Service Fusion", logoSrc: LOGOS.servicefusion, rating: "4.4", bestFor: "HVAC & plumbing", description: "HVAC and plumbing value.", reviewHref: getFieldServiceReviewUrl("service-fusion"), startingPrice: "From ~$99/mo", standoutFeature: "HVAC; plumbing" },
  { slug: "jobber", name: "Jobber", logoSrc: LOGOS.jobber, rating: "4.6", bestFor: "contractors", description: "All-in-one for small to mid-size.", reviewHref: getFieldServiceReviewUrl("jobber"), startingPrice: "From $29/mo billed annually (Core, 1 user)", standoutFeature: "All-in-one" },
  { slug: "housecall-pro", name: "Housecall Pro", logoSrc: LOGOS.housecallpro, rating: "4.5", bestFor: "home service", description: "Lower cost for home service pros.", reviewHref: getFieldServiceReviewUrl("housecall-pro"), startingPrice: "From ~$49/mo", standoutFeature: "Home service" },
  { slug: "mhelpdesk", name: "mHelpDesk", logoSrc: LOGOS.mhelpdesk, rating: "4.2", bestFor: "contractors", description: "Contractors and technicians.", reviewHref: getFieldServiceReviewUrl("mhelpdesk"), startingPrice: "From ~$49/mo", standoutFeature: "Contractors" },
];
...
const FIELDPULSE_ALTERNATIVES: AlternativesTopPick[] = [
  { slug: "jobber", name: "Jobber", logoSrc: LOGOS.jobber, rating: "4.6", bestFor: "overall balance", description: "The most common generalist FSM for contractors.", reviewHref: getFieldServiceReviewUrl("jobber"), compareHref: getFieldServiceCompareUrl("fieldpulse-vs-jobber"), startingPrice: "From $29/mo billed annually (Core, 1 user)", standoutFeature: "All-in-one; polish" },
...
const SERVICETRADE_ALTERNATIVES: AlternativesTopPick[] = [
  ...
  { slug: "jobber", name: "Jobber", logoSrc: LOGOS.jobber, rating: "4.6", bestFor: "SMB generalist", description: "Approachable FSM when commercial complexity is lighter.", reviewHref: getFieldServiceReviewUrl("jobber"), startingPrice: "From $29/mo billed annually (Core, 1 user)", standoutFeature: "SMB FSM" },
...
const WORKWAVE_SERVICE_ALTERNATIVES: AlternativesTopPick[] = [
  { slug: "jobber", name: "Jobber", logoSrc: LOGOS.jobber, rating: "4.6", bestFor: "general contractor FSM", description: "Flexible all-in-one for many trades and SMB teams.", reviewHref: getFieldServiceReviewUrl("jobber"), compareHref: getFieldServiceCompareUrl("workwave-service-vs-jobber"), startingPrice: "From $29/mo billed annually (Core, 1 user)", standoutFeature: "Generalist" },
...
const BUILDOPS_ALTERNATIVES: AlternativesTopPick[] = [
  ...
  { slug: "jobber", name: "Jobber", logoSrc: LOGOS.jobber, rating: "4.6", bestFor: "SMB generalist", description: "Not a mechanical-enterprise replacement—only if scope is lighter.", reviewHref: getFieldServiceReviewUrl("jobber"), startingPrice: "From $29/mo billed annually (Core, 1 user)", standoutFeature: "SMB" },
...
const ORACLE_FIELD_SERVICE_ALTERNATIVES: AlternativesTopPick[] = [
  ...
  { slug: "jobber", name: "Jobber", logoSrc: LOGOS.jobber, rating: "4.6", bestFor: "SMB contractors", description: "If you landed here by mistake—SMB contractors usually start here.", reviewHref: getFieldServiceReviewUrl("jobber"), startingPrice: "From $29/mo billed annually (Core, 1 user)", standoutFeature: "SMB FSM" },
];
...
const SIMPRO_ALTERNATIVES: AlternativesTopPick[] = [
  ...
  { slug: "jobber", name: "Jobber", logoSrc: LOGOS.jobber, rating: "4.6", bestFor: "SMB contractors", description: "All-in-one balance when scope is lighter.", reviewHref: getFieldServiceReviewUrl("jobber"), startingPrice: "From $29/mo billed annually (Core, 1 user)", standoutFeature: "SMB" },
...
const ZUPER_ALTERNATIVES: AlternativesTopPick[] = [
  { slug: "jobber", name: "Jobber", logoSrc: LOGOS.jobber, rating: "4.6", bestFor: "all-in-one SMB", description: "Default contractor FSM for many teams.", reviewHref: getFieldServiceReviewUrl("jobber"), compareHref: getFieldServiceCompareUrl("zuper-vs-jobber"), startingPrice: "From $29/mo billed annually (Core, 1 user)", standoutFeature: "All-in-one" },
  { slug: "fieldpulse", name: "FieldPulse", logoSrc: LOGOS.fieldpulse, rating: "4.4", bestFor: "dispatch-heavy trades", description: "Ops-forward FSM for growing contractor crews.", reviewHref: getFieldServiceReviewUrl("fieldpulse"), startingPrice: "From ~$99/mo", standoutFeature: "Dispatch" },
