...
import {
  ...
  APPLIANCE_REPAIR_PROJECT_MANAGEMENT_BEST_FOR_PAGE_PROPS,
  GARAGE_DOOR_PROJECT_MANAGEMENT_BEST_FOR_PAGE_PROPS,
  LOCKSMITH_PROJECT_MANAGEMENT_BEST_FOR_PAGE_PROPS,
  FLOORING_PROJECT_MANAGEMENT_BEST_FOR_PAGE_PROPS,
  FENCE_DECK_PROJECT_MANAGEMENT_BEST_FOR_PAGE_PROPS,
  GLASS_WINDOW_INSTALLERS_PROJECT_MANAGEMENT_BEST_FOR_PAGE_PROPS,
  CONCRETE_CONTRACTORS_PROJECT_MANAGEMENT_BEST_FOR_PAGE_PROPS,
  EXCAVATION_PROJECT_MANAGEMENT_BEST_FOR_PAGE_PROPS,
  AUTO_REPAIR_PROJECT_MANAGEMENT_BEST_FOR_PAGE_PROPS,
  MOBILE_MECHANICS_PROJECT_MANAGEMENT_BEST_FOR_PAGE_PROPS,
  CLEANING_FRANCHISES_PROJECT_MANAGEMENT_BEST_FOR_PAGE_PROPS,
  EVENT_SERVICES_PROJECT_MANAGEMENT_BEST_FOR_PAGE_PROPS,
  HOME_INSPECTORS_PROJECT_MANAGEMENT_BEST_FOR_PAGE_PROPS,
...
const PM_BEST_FOR_PROPS_BY_SLUG: Record<string, BestForTemplateProps> = {
  ...
  "appliance-repair": APPLIANCE_REPAIR_PROJECT_MANAGEMENT_BEST_FOR_PAGE_PROPS,
  "garage-door": GARAGE_DOOR_PROJECT_MANAGEMENT_BEST_FOR_PAGE_PROPS,
  locksmith: LOCKSMITH_PROJECT_MANAGEMENT_BEST_FOR_PAGE_PROPS,
  flooring: FLOORING_PROJECT_MANAGEMENT_BEST_FOR_PAGE_PROPS,
  "fence-deck": FENCE_DECK_PROJECT_MANAGEMENT_BEST_FOR_PAGE_PROPS,
  "glass-window-installers": GLASS_WINDOW_INSTALLERS_PROJECT_MANAGEMENT_BEST_FOR_PAGE_PROPS,
  "concrete-contractors": CONCRETE_CONTRACTORS_PROJECT_MANAGEMENT_BEST_FOR_PAGE_PROPS,
  excavation: EXCAVATION_PROJECT_MANAGEMENT_BEST_FOR_PAGE_PROPS,
  "auto-repair": AUTO_REPAIR_PROJECT_MANAGEMENT_BEST_FOR_PAGE_PROPS,
  "mobile-mechanics": MOBILE_MECHANICS_PROJECT_MANAGEMENT_BEST_FOR_PAGE_PROPS,
  "cleaning-franchises": CLEANING_FRANCHISES_PROJECT_MANAGEMENT_BEST_FOR_PAGE_PROPS,
  "event-services": EVENT_SERVICES_PROJECT_MANAGEMENT_BEST_FOR_PAGE_PROPS,
