...
export const HVAC_PAGE_PROPS = {
  ...
  featuredProducts: [
    {
      slug: "gusto",
      name: "Gusto",
      badge: "Best overall for small HVAC companies",
      description:
    ...
    },
    {
      ...
      badge: "Best for HVAC companies using QuickBooks",
      description:
    ...
    },
    {
      slug: "adp",
      name: "ADP",
      badge: "Best for growing HVAC teams",
      description:
  ...
  comparisonTableRows: [
    {
      ...
      name: "Gusto",
      logoSrc: "/Logos/gusto.jpeg",
      bestFor: "Best overall for small HVAC",
      startingPrice: "$49/mo",
  ...
  faqItems: [
    {
      q: "What is the best payroll software for HVAC companies?",
      a: "Gusto is our top pick for most small HVAC companies: it handles W-2 techs and 1099 subcontractors in one system, offers a contractor portal and automatic tax forms, and includes time tracking. QuickBooks Payroll is best if you already use QuickBooks and need labor cost in job costing. OnPay is a strong value option; ADP fits growing teams that want full-service support.",
    },
    {
    ...
    {
      q: "What payroll software works best with QuickBooks for HVAC?",
      a: "QuickBooks Payroll runs inside QuickBooks, so labor cost from payroll posts directly to jobs—ideal for HVAC job costing and service calls. If you run invoicing and books in QuickBooks, payroll in the same system keeps everything in one place. Gusto and OnPay integrate with QuickBooks but don't push labor cost to jobs the same way.",
    },
    {
