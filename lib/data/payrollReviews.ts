...
const USE_CASE_LINKS: { label: string; href: string }[] = [
  ...
  { label: "Best for appliance repair", href: getPayrollBestForUrl("appliance-repair") },
  { label: "Best for garage door companies", href: getPayrollBestForUrl("garage-door") },
  { label: "Best for locksmith businesses", href: getPayrollBestForUrl("locksmith") },
  { label: "Best for flooring contractors", href: getPayrollBestForUrl("flooring") },
  { label: "Best for fence and deck builders", href: getPayrollBestForUrl("fence-deck") },
  { label: "Best for glass and window installers", href: getPayrollBestForUrl("glass-window-installers") },
  { label: "Best for concrete contractors", href: getPayrollBestForUrl("concrete-contractors") },
  { label: "Best for excavation companies", href: getPayrollBestForUrl("excavation") },
  { label: "Best for mobile mechanics", href: getPayrollBestForUrl("mobile-mechanics") },
  { label: "Best for cleaning franchises", href: getPayrollBestForUrl("cleaning-franchises") },
  { label: "Best for event services", href: getPayrollBestForUrl("event-services") },
  { label: "Best for home inspectors", href: getPayrollBestForUrl("home-inspectors") },
