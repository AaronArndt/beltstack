...
const XERO_ALTERNATIVES: AlternativesTopPick[] = [
  ...
  { slug: "zoho-books", name: "Zoho Books", logoSrc: "/Logos/zoho.png", rating: "4.4", bestFor: "value and automation", description: "Affordable with strong automation. Good for Zoho users.", reviewHref: getAccountingReviewUrl("zoho-books"), compareHref: getAccountingCompareUrl("xero-vs-zoho-books"), startingPrice: "$15/mo", standoutFeature: "Value; automation" },
...
const zohoBooksPage: AlternativesTemplateProps = {
  ...
  comparisonTableRows: buildTableRows(
    { slug: "zoho-books", name: "Zoho Books", logoSrc: "/Logos/zoho.png", bestFor: "value and Zoho ecosystem", startingPrice: "$15/mo", standoutFeature: "Value; automation", reviewHref: getAccountingReviewUrl("zoho-books") },
...
const WAVE_ALTERNATIVES: AlternativesTopPick[] = [
  ...
  { slug: "zoho-books", name: "Zoho Books", logoSrc: "/Logos/zoho.png", rating: "4.4", bestFor: "value", description: "Affordable with automation and projects.", reviewHref: getAccountingReviewUrl("zoho-books"), compareHref: getAccountingCompareUrl("zoho-books-vs-wave"), startingPrice: "$15/mo", standoutFeature: "Value; automation" },
...
const SAGE_ALTERNATIVES: AlternativesTopPick[] = [
  ...
  { slug: "zoho-books", name: "Zoho Books", logoSrc: "/Logos/zoho.png", rating: "4.4", bestFor: "value", description: "Affordable with automation.", reviewHref: getAccountingReviewUrl("zoho-books"), startingPrice: "$15/mo", standoutFeature: "Value; automation" },
  { slug: "wave", name: "Wave", logoSrc: "/Logos/wave.jpeg", rating: "4.3", bestFor: "free accounting", description: "Free accounting and invoicing.", reviewHref: getAccountingReviewUrl("wave"), startingPrice: "Free", standoutFeature: "Free core accounting" },
];
...
const ODOO_ALTERNATIVES: AlternativesTopPick[] = [
  ...
  { slug: "zoho-books", name: "Zoho Books", logoSrc: "/Logos/zoho.png", rating: "4.4", bestFor: "value and Zoho suite", description: "Affordable; part of Zoho suite.", reviewHref: getAccountingReviewUrl("zoho-books"), startingPrice: "$15/mo", standoutFeature: "Value; automation" },
  { slug: "wave", name: "Wave", logoSrc: "/Logos/wave.jpeg", rating: "4.3", bestFor: "free accounting", description: "Free accounting and invoicing.", reviewHref: getAccountingReviewUrl("wave"), startingPrice: "Free", standoutFeature: "Free core accounting" },
];
