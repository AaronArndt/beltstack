...
export const FIELD_SERVICE_BY_BUSINESS_TYPE: { label: string; href: string }[] = [
  ...
  { label: "Appliance repair businesses", href: getFieldServiceBestForUrl("appliance-repair") },
  { label: "Garage door companies", href: getFieldServiceBestForUrl("garage-door") },
  { label: "Locksmith businesses", href: getFieldServiceBestForUrl("locksmith") },
  { label: "Flooring contractors", href: getFieldServiceBestForUrl("flooring") },
  { label: "Fence & deck builders", href: getFieldServiceBestForUrl("fence-deck") },
  { label: "Glass & window installers", href: getFieldServiceBestForUrl("glass-window-installers") },
  { label: "Concrete contractors", href: getFieldServiceBestForUrl("concrete-contractors") },
  { label: "Excavation companies", href: getFieldServiceBestForUrl("excavation") },
  { label: "Auto repair shops", href: getFieldServiceBestForUrl("auto-repair") },
  { label: "Mobile mechanics", href: getFieldServiceBestForUrl("mobile-mechanics") },
  { label: "Cleaning franchises", href: getFieldServiceBestForUrl("cleaning-franchises") },
  { label: "Event services", href: getFieldServiceBestForUrl("event-services") },
  { label: "Home inspectors", href: getFieldServiceBestForUrl("home-inspectors") },
