...
export const BEST_FOR_BY_TRADE: { label: string; href: string }[] = [
  ...
  { label: "Appliance repair businesses", href: getSeoToolsBestForUrl("appliance-repair") },
  { label: "Garage door companies", href: getSeoToolsBestForUrl("garage-door") },
  { label: "Locksmith businesses", href: getSeoToolsBestForUrl("locksmith") },
  { label: "Flooring contractors", href: getSeoToolsBestForUrl("flooring") },
  { label: "Fence & deck builders", href: getSeoToolsBestForUrl("fence-deck") },
  { label: "Glass & window installers", href: getSeoToolsBestForUrl("glass-window-installers") },
  { label: "Concrete contractors", href: getSeoToolsBestForUrl("concrete-contractors") },
  { label: "Excavation companies", href: getSeoToolsBestForUrl("excavation") },
  { label: "Auto repair shops", href: getSeoToolsBestForUrl("auto-repair") },
  { label: "Mobile mechanics", href: getSeoToolsBestForUrl("mobile-mechanics") },
  { label: "Cleaning franchises", href: getSeoToolsBestForUrl("cleaning-franchises") },
  { label: "Event services", href: getSeoToolsBestForUrl("event-services") },
  { label: "Home inspectors", href: getSeoToolsBestForUrl("home-inspectors") },
