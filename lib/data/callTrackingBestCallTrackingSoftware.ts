...
export const TOP_PICKS: BestCallTrackingPick[] = [
  {
    ...
    compareSlugs: ["invoca-vs-callrail", "callrail-vs-calltrackingmetrics", "callrail-vs-whatconverts", "ringba-vs-callrail"],
    ...
    pricingSummary: "Lead Tracking from $55/mo ($50 annual); 5 numbers and 250 minutes on every listed plan, then usage. Premium CI is a higher plan, not more minutes.",
  ...
  },
  {
    ...
    pricingSummary: "Quote-based Pro/Enterprise/Elite. Signal AI, Quality Management, and PreSense are add-ons. No public dollar card.",
