...
export const ROOFING_PAGE_PROPS = {
  ...
  featuredProducts: [
    {
      slug: "gusto",
      name: "Gusto",
      badge: "Best overall for small roofing companies",
      description:
    ...
    },
    {
      ...
      badge: "Best for roofing companies using QuickBooks",
      description:
    ...
    },
    {
      slug: "adp",
      name: "ADP",
      badge: "Best for growing roofing companies",
      description:
  ...
  comparisonTableRows: [
    {
      ...
      name: "Gusto",
      logoSrc: "/Logos/gusto.jpeg",
      bestFor: "Best overall for small roofing",
      startingPrice: "$40/mo",
    ...
    },
    {
      ...
      name: "QuickBooks Payroll",
      logoSrc: "/Logos/quickbooks.png",
      bestFor: "Roofing using QuickBooks",
      startingPrice: "$30/mo",
      payrollTypes: "W-2, 1099",
    ...
    },
    {
      ...
      name: "ADP",
      logoSrc: "/Logos/adp.jpeg",
      bestFor: "Growing roofing companies",
      startingPrice: "Custom pricing",
  ...
  faqItems: [
    {
      q: "What is the best payroll software for roofing companies?",
      a: "Gusto is our top pick for most small roofing companies: it handles W-2 crew and 1099 subcontractors in one system, offers a contractor portal and automatic tax forms, and includes time tracking. QuickBooks Payroll is best if you already use QuickBooks and need labor cost in job costing. OnPay is a strong value option; ADP fits growing teams that want full-service support.",
    },
    {
    ...
    {
      q: "What payroll software works best with QuickBooks for roofing?",
      a: "QuickBooks Payroll runs inside QuickBooks, so labor cost from payroll posts directly to jobs—ideal for roofing job costing and projects. If you run estimates, invoicing, and books in QuickBooks, payroll in the same system keeps everything in one place. Gusto and OnPay integrate with QuickBooks but don't push labor cost to jobs the same way.",
    },
    {
      q: "How do I handle seasonal crew for roofing payroll?",
      a: "Gusto, QuickBooks Payroll, and OnPay all let you add and remove employees as needed—no long-term contract required. Run payroll for your core crew and add seasonal workers when busy; contractor payments for 1099 subs are in the same system. Choose software with straightforward setup so you're not locked into complex plans.",
    },
    {
      q: "What payroll software is best for job costing in roofing?",
      a: "QuickBooks Payroll is best for job costing when you use QuickBooks: payroll and labor cost post to the jobs you assign, so project reports stay accurate. Gusto and OnPay sync to QuickBooks but don't push cost to jobs natively. If job costing in QuickBooks is central to your roofing accounting, QuickBooks Payroll is the fit.",
    },
  ] as BestForFaqItem[],
};
