...
const SQUARE_ALTERNATIVES: AlternativesTopPick[] = [
  ...
  { slug: "clover-pos", name: "Clover POS", logoSrc: POS_LOGOS.clover, rating: "4.3", bestFor: "hardware and apps", description: "Wide hardware and app ecosystem; higher typical cost.", reviewHref: getPosReviewUrl("clover-pos"), compareHref: getPosCompareUrl("square-pos-vs-clover-pos"), startingPrice: "From ~$69/mo", standoutFeature: "Hardware; app market" },
  { slug: "lightspeed-pos", name: "Lightspeed POS", logoSrc: POS_LOGOS.lightspeed, rating: "4.4", bestFor: "retail", description: "Deeper inventory and multi-location for retail.", reviewHref: getPosReviewUrl("lightspeed-pos"), startingPrice: "From ~$69/mo", standoutFeature: "Retail; multi-location" },
  { slug: "toast-pos", name: "Toast POS", logoSrc: POS_LOGOS.toast, rating: "4.5", bestFor: "restaurants", description: "Table management, kitchen display, online ordering.", reviewHref: getPosReviewUrl("toast-pos"), compareHref: getPosCompareUrl("toast-pos-vs-square-pos"), startingPrice: "Quote", standoutFeature: "Restaurant suite" },
  { slug: "vend-pos", name: "Vend POS (Lightspeed Retail)", logoSrc: POS_LOGOS.vend, rating: "4.3", bestFor: "retail", description: "Retail-focused; now part of Lightspeed.", reviewHref: getPosReviewUrl("vend-pos"), startingPrice: "From ~$69/mo", standoutFeature: "Retail; multi-store" },
];

const squareOriginalRow: AlternativesTableRow = {
  slug: "square-pos", name: "Square POS", logoSrc: POS_LOGOS.square, bestFor: "overall small business", startingPrice: "Free software", standoutFeature: "Simple; flexible", reviewHref: getPosReviewUrl("square-pos"),
};

const squarePage: AlternativesTemplateProps = {
  title: "Best Square POS Alternatives (2026)",
  subtitle: "If Square POS isn't the right fit—because you need ecommerce, deeper retail, restaurant features, or different hardware—these POS alternatives offer strong options for small businesses.",
  productName: "Square POS",
  productSlug: "square-pos",
  categoryHref: CATEGORY.href,
  categoryLabel: CATEGORY.label,
  originalReviewHref: getPosReviewUrl("square-pos"),
  quickAnswerParagraphs: [
    "Square POS is a strong default for many small businesses; alternatives include Shopify POS for ecommerce, Clover for hardware and apps, Lightspeed for retail depth, Toast for restaurants, and Vend for retail multi-store. Shopify and Clover are the most common alternatives.",
  ],
  ...
  detailedAlternatives: [
    ...
    { productName: "Clover POS", heading: "Best for hardware and apps", body: "Clover offers a wide choice of terminals and an app market. For businesses that want more hardware and add-on options.", reviewHref: getPosReviewUrl("clover-pos"), compareHref: getPosCompareUrl("square-pos-vs-clover-pos") },
    { productName: "Lightspeed POS", heading: "Best for retail", body: "Lightspeed provides deeper inventory and multi-location for retail. For stores that outgrow Square's retail depth.", reviewHref: getPosReviewUrl("lightspeed-pos") },
    { productName: "Toast POS", heading: "Best for restaurants", body: "Toast is purpose-built for restaurants with table and kitchen management. Compare with Square for food service.", reviewHref: getPosReviewUrl("toast-pos"), compareHref: getPosCompareUrl("toast-pos-vs-square-pos") },
    { productName: "Vend POS", heading: "Best for retail", body: "Vend (Lightspeed Retail) is retail-focused with multi-store support. Part of the Lightspeed family.", reviewHref: getPosReviewUrl("vend-pos") },
  ],
  ...
  faqItems: [
    { q: "What is the best Square POS alternative?", a: "Shopify POS for ecommerce; Clover for hardware and apps; Lightspeed for retail; Toast for restaurants. Choose by your primary use case." },
...
const SHOPIFY_ALTERNATIVES: AlternativesTopPick[] = [
  { slug: "square-pos", name: "Square POS", logoSrc: POS_LOGOS.square, rating: "4.6", bestFor: "no monthly fee", description: "Free software and simple setup; no Shopify required.", reviewHref: getPosReviewUrl("square-pos"), compareHref: getPosCompareUrl("square-pos-vs-shopify-pos"), startingPrice: "Free software", standoutFeature: "Free; simple" },
  { slug: "lightspeed-pos", name: "Lightspeed POS", logoSrc: POS_LOGOS.lightspeed, rating: "4.4", bestFor: "retail", description: "Retail-first with deeper inventory and multi-location.", reviewHref: getPosReviewUrl("lightspeed-pos"), compareHref: getPosCompareUrl("shopify-pos-vs-lightspeed-pos"), startingPrice: "From ~$69/mo", standoutFeature: "Retail; multi-location" },
  { slug: "clover-pos", name: "Clover POS", logoSrc: POS_LOGOS.clover, rating: "4.3", bestFor: "hardware and apps", description: "Wide hardware and app ecosystem.", reviewHref: getPosReviewUrl("clover-pos"), startingPrice: "From ~$69/mo", standoutFeature: "Hardware; apps" },
  { slug: "vend-pos", name: "Vend POS (Lightspeed Retail)", logoSrc: POS_LOGOS.vend, rating: "4.3", bestFor: "retail", description: "Retail-focused; part of Lightspeed.", reviewHref: getPosReviewUrl("vend-pos"), startingPrice: "From ~$69/mo", standoutFeature: "Retail; multi-store" },
  { slug: "toast-pos", name: "Toast POS", logoSrc: POS_LOGOS.toast, rating: "4.5", bestFor: "restaurants", description: "Restaurant-focused with table and kitchen management.", reviewHref: getPosReviewUrl("toast-pos"), startingPrice: "Quote", standoutFeature: "Restaurant suite" },
];
...
const shopifyPage: AlternativesTemplateProps = {
  ...
  detailedAlternatives: [
    { productName: "Square POS", heading: "Best for no monthly fee", body: "Square offers free POS software and doesn't require Shopify. For in-person-first businesses that want simple pricing.", reviewHref: getPosReviewUrl("square-pos"), compareHref: getPosCompareUrl("square-pos-vs-shopify-pos") },
    { productName: "Lightspeed POS", heading: "Best for retail", body: "Lightspeed is retail-first with deeper inventory and multi-location. For stores that don't need Shopify's ecommerce.", reviewHref: getPosReviewUrl("lightspeed-pos"), compareHref: getPosCompareUrl("shopify-pos-vs-lightspeed-pos") },
    { productName: "Clover POS", heading: "Best for hardware and apps", body: "Clover offers a wide hardware and app ecosystem. Alternative for businesses that want flexibility.", reviewHref: getPosReviewUrl("clover-pos") },
...
const LIGHTSPEED_ALTERNATIVES: AlternativesTopPick[] = [
  ...
  { slug: "square-pos", name: "Square POS", logoSrc: POS_LOGOS.square, rating: "4.6", bestFor: "simplicity", description: "Free software and simpler setup for single-location.", reviewHref: getPosReviewUrl("square-pos"), startingPrice: "Free software", standoutFeature: "Free; simple" },
  { slug: "vend-pos", name: "Vend POS (Lightspeed Retail)", logoSrc: POS_LOGOS.vend, rating: "4.3", bestFor: "retail", description: "Same family; retail-focused alternative.", reviewHref: getPosReviewUrl("vend-pos"), compareHref: getPosCompareUrl("lightspeed-pos-vs-vend-pos"), startingPrice: "From ~$69/mo", standoutFeature: "Retail; Lightspeed family" },
  { slug: "clover-pos", name: "Clover POS", logoSrc: POS_LOGOS.clover, rating: "4.3", bestFor: "hardware and apps", description: "Wide hardware and app ecosystem.", reviewHref: getPosReviewUrl("clover-pos"), startingPrice: "From ~$69/mo", standoutFeature: "Hardware; apps" },
  { slug: "toast-pos", name: "Toast POS", logoSrc: POS_LOGOS.toast, rating: "4.5", bestFor: "restaurants", description: "Restaurant-focused POS.", reviewHref: getPosReviewUrl("toast-pos"), startingPrice: "Quote", standoutFeature: "Restaurant suite" },
];

const lightspeedPage: AlternativesTemplateProps = {
  ...squarePage,
  title: "Best Lightspeed POS Alternatives (2026)",
  subtitle: "If Lightspeed POS isn't the right fit—because of cost, ecommerce focus, or simpler needs—these POS alternatives offer strong options for retail and multi-location.",
  productName: "Lightspeed POS",
  productSlug: "lightspeed-pos",
  originalReviewHref: getPosReviewUrl("lightspeed-pos"),
  quickAnswerParagraphs: [
    "Lightspeed POS is strong for retail and multi-location; alternatives include Shopify POS for ecommerce, Square for simplicity and free software, Vend (same family) for a similar retail focus, and Clover or Toast for different use cases. Shopify and Square are the main alternatives.",
  ],
  whyPeopleLookForAlternatives: [
  ...
  comparisonTableRows: buildTableRows(
    { slug: "lightspeed-pos", name: "Lightspeed POS", logoSrc: POS_LOGOS.lightspeed, bestFor: "retail; multi-location", startingPrice: "From ~$69/mo", standoutFeature: "Retail; inventory", reviewHref: getPosReviewUrl("lightspeed-pos") },
  ...
  detailedAlternatives: [
    ...
    { productName: "Square POS", heading: "Best for simplicity", body: "Square offers free software and simpler setup. For single-location or lower complexity.", reviewHref: getPosReviewUrl("square-pos") },
    { productName: "Vend POS", heading: "Best for retail (same family)", body: "Vend (Lightspeed Retail) is in the Lightspeed family with similar retail focus. Compare for fit.", reviewHref: getPosReviewUrl("vend-pos"), compareHref: getPosCompareUrl("lightspeed-pos-vs-vend-pos") },
    { productName: "Clover POS", heading: "Best for hardware and apps", body: "Clover offers a wide hardware and app ecosystem.", reviewHref: getPosReviewUrl("clover-pos") },
  ...
  faqItems: [
    { q: "What is the best Lightspeed POS alternative?", a: "Shopify POS for ecommerce; Square for simplicity and free software; Vend for similar retail in the same family; Clover for hardware and apps." },
...
const CLOVER_ALTERNATIVES: AlternativesTopPick[] = [
  ...
  { slug: "lightspeed-pos", name: "Lightspeed POS", logoSrc: POS_LOGOS.lightspeed, rating: "4.4", bestFor: "retail", description: "Deeper retail inventory and multi-location.", reviewHref: getPosReviewUrl("lightspeed-pos"), startingPrice: "From ~$69/mo", standoutFeature: "Retail; multi-location" },
  { slug: "toast-pos", name: "Toast POS", logoSrc: POS_LOGOS.toast, rating: "4.5", bestFor: "restaurants", description: "Purpose-built for restaurants.", reviewHref: getPosReviewUrl("toast-pos"), startingPrice: "Quote", standoutFeature: "Restaurant suite" },
  { slug: "vend-pos", name: "Vend POS (Lightspeed Retail)", logoSrc: POS_LOGOS.vend, rating: "4.3", bestFor: "retail", description: "Retail-focused; part of Lightspeed.", reviewHref: getPosReviewUrl("vend-pos"), startingPrice: "From ~$69/mo", standoutFeature: "Retail; multi-store" },
];

const cloverPage: AlternativesTemplateProps = {
  ...squarePage,
  title: "Best Clover POS Alternatives (2026)",
  subtitle: "If Clover POS isn't the right fit—because of cost, preference for simpler setup, or different features—these POS alternatives offer strong options.",
  productName: "Clover POS",
  productSlug: "clover-pos",
  originalReviewHref: getPosReviewUrl("clover-pos"),
  quickAnswerParagraphs: [
    "Clover POS offers a wide hardware and app ecosystem; alternatives include Square for free software and simplicity, Shopify for ecommerce, Lightspeed for retail depth, and Toast for restaurants. Square is the most common alternative for lower cost.",
  ],
  whyPeopleLookForAlternatives: [
  ...
  comparisonTableRows: buildTableRows(
    { slug: "clover-pos", name: "Clover POS", logoSrc: POS_LOGOS.clover, bestFor: "hardware and apps", startingPrice: "From ~$69/mo", standoutFeature: "Hardware; app market", reviewHref: getPosReviewUrl("clover-pos") },
    CLOVER_ALTERNATIVES
  ),
  detailedAlternatives: [
    { productName: "Square POS", heading: "Best for free software", body: "Square offers free POS software and simpler pricing. For businesses that want to minimize cost and complexity.", reviewHref: getPosReviewUrl("square-pos"), compareHref: getPosCompareUrl("square-pos-vs-clover-pos") },
    ...
    { productName: "Lightspeed POS", heading: "Best for retail", body: "Lightspeed provides deeper retail inventory and multi-location.", reviewHref: getPosReviewUrl("lightspeed-pos") },
    { productName: "Toast POS", heading: "Best for restaurants", body: "Toast is purpose-built for restaurants with full restaurant suite.", reviewHref: getPosReviewUrl("toast-pos") },
    { productName: "Vend POS", heading: "Best for retail", body: "Vend (Lightspeed Retail) is retail-focused with multi-store support.", reviewHref: getPosReviewUrl("vend-pos") },
  ],
  relatedComparisons: [
    posRel("square-pos-vs-clover-pos"),
  ...
  faqItems: [
    { q: "What is the best Clover POS alternative?", a: "Square for free software and simplicity; Shopify for ecommerce; Lightspeed for retail; Toast for restaurants." },
...
const TOAST_ALTERNATIVES: AlternativesTopPick[] = [
  { slug: "square-pos", name: "Square POS", logoSrc: POS_LOGOS.square, rating: "4.6", bestFor: "simplicity and cost", description: "Simpler and cheaper for cafes or simple restaurant setups.", reviewHref: getPosReviewUrl("square-pos"), compareHref: getPosCompareUrl("toast-pos-vs-square-pos"), startingPrice: "Free software", standoutFeature: "Free; simple" },
  ...
  { slug: "clover-pos", name: "Clover POS", logoSrc: POS_LOGOS.clover, rating: "4.3", bestFor: "general POS", description: "General-purpose POS with restaurant apps.", reviewHref: getPosReviewUrl("clover-pos"), startingPrice: "From ~$69/mo", standoutFeature: "Hardware; apps" },
  { slug: "lightspeed-pos", name: "Lightspeed POS", logoSrc: POS_LOGOS.lightspeed, rating: "4.4", bestFor: "retail", description: "Retail-focused; less restaurant depth.", reviewHref: getPosReviewUrl("lightspeed-pos"), startingPrice: "From ~$69/mo", standoutFeature: "Retail" },
...
const toastPage: AlternativesTemplateProps = {
  ...squarePage,
  title: "Best Toast POS Alternatives (2026)",
  subtitle: "If Toast POS isn't the right fit—because of cost, simpler needs, or different restaurant focus—these POS alternatives offer strong options for restaurants and food service.",
  productName: "Toast POS",
  productSlug: "toast-pos",
  originalReviewHref: getPosReviewUrl("toast-pos"),
  quickAnswerParagraphs: [
    "Toast POS is built for restaurants; alternatives include Square for simplicity and lower cost, TouchBistro for another strong restaurant option, and Clover for general-purpose POS with restaurant apps. Square and TouchBistro are the main alternatives.",
  ],
  whyPeopleLookForAlternatives: [
  ...
  comparisonTableRows: buildTableRows(
    { slug: "toast-pos", name: "Toast POS", logoSrc: POS_LOGOS.toast, bestFor: "restaurants", startingPrice: "Quote", standoutFeature: "Restaurant suite", reviewHref: getPosReviewUrl("toast-pos") },
    TOAST_ALTERNATIVES
  ),
  detailedAlternatives: [
    { productName: "Square POS", heading: "Best for simplicity and cost", body: "Square is simpler and cheaper for cafes or very simple restaurant setups. Free software and pay-per-swipe.", reviewHref: getPosReviewUrl("square-pos"), compareHref: getPosCompareUrl("toast-pos-vs-square-pos") },
    ...
    { productName: "Clover POS", heading: "Best for general POS", body: "Clover is general-purpose with restaurant apps; less depth than Toast for full-service restaurants.", reviewHref: getPosReviewUrl("clover-pos") },
    { productName: "Lightspeed POS", heading: "Best for retail", body: "Lightspeed is retail-focused. For businesses that need retail more than restaurant features.", reviewHref: getPosReviewUrl("lightspeed-pos") },
  ...
  faqItems: [
    { q: "What is the best Toast POS alternative?", a: "Square for simplicity and cost; TouchBistro for another restaurant-focused option; Clover for general POS with restaurant apps." },
...
const REVEL_ALTERNATIVES: AlternativesTopPick[] = [
  { slug: "lightspeed-pos", name: "Lightspeed POS", logoSrc: POS_LOGOS.lightspeed, rating: "4.4", bestFor: "retail", description: "Retail and multi-location; lower entry cost.", reviewHref: getPosReviewUrl("lightspeed-pos"), startingPrice: "From ~$69/mo", standoutFeature: "Retail; multi-location" },
  { slug: "square-pos", name: "Square POS", logoSrc: POS_LOGOS.square, rating: "4.6", bestFor: "simplicity", description: "Simpler and more affordable for small or single-location.", reviewHref: getPosReviewUrl("square-pos"), startingPrice: "Free software", standoutFeature: "Free; simple" },
  { slug: "toast-pos", name: "Toast POS", logoSrc: POS_LOGOS.toast, rating: "4.5", bestFor: "restaurants", description: "Restaurant-focused for food service at scale.", reviewHref: getPosReviewUrl("toast-pos"), startingPrice: "Quote", standoutFeature: "Restaurant suite" },
...
const revelPage: AlternativesTemplateProps = {
  ...
  detailedAlternatives: [
    { productName: "Lightspeed POS", heading: "Best for retail", body: "Lightspeed offers strong retail and multi-location at lower entry cost for mid-size operations.", reviewHref: getPosReviewUrl("lightspeed-pos") },
    { productName: "Square POS", heading: "Best for simplicity", body: "Square is simpler and more affordable for small or single-location businesses.", reviewHref: getPosReviewUrl("square-pos") },
    { productName: "Toast POS", heading: "Best for restaurants", body: "Toast is restaurant-focused for food service at scale.", reviewHref: getPosReviewUrl("toast-pos") },
    ...
    { productName: "Clover POS", heading: "Best for hardware and apps", body: "Clover has a wide hardware and app ecosystem.", reviewHref: getPosReviewUrl("clover-pos") },
  ],
  relatedComparisons: [],
...
const VEND_ALTERNATIVES: AlternativesTopPick[] = [
  { slug: "lightspeed-pos", name: "Lightspeed POS", logoSrc: POS_LOGOS.lightspeed, rating: "4.4", bestFor: "same family", description: "Full Lightspeed suite; same family as Vend.", reviewHref: getPosReviewUrl("lightspeed-pos"), compareHref: getPosCompareUrl("lightspeed-pos-vs-vend-pos"), startingPrice: "From ~$69/mo", standoutFeature: "Lightspeed family" },
  { slug: "square-pos", name: "Square POS", logoSrc: POS_LOGOS.square, rating: "4.6", bestFor: "simplicity", description: "Simpler and lower cost for single-location retail.", reviewHref: getPosReviewUrl("square-pos"), startingPrice: "Free software", standoutFeature: "Free; simple" },
  { slug: "shopify-pos", name: "Shopify POS", logoSrc: POS_LOGOS.shopify, rating: "4.5", bestFor: "ecommerce", description: "Unified online and in-store with Shopify.", reviewHref: getPosReviewUrl("shopify-pos"), startingPrice: "From $39/mo", standoutFeature: "Ecommerce unified" },
  { slug: "clover-pos", name: "Clover POS", logoSrc: POS_LOGOS.clover, rating: "4.3", bestFor: "hardware and apps", description: "Wide hardware and app ecosystem.", reviewHref: getPosReviewUrl("clover-pos"), startingPrice: "From ~$69/mo", standoutFeature: "Hardware; apps" },
  { slug: "toast-pos", name: "Toast POS", logoSrc: POS_LOGOS.toast, rating: "4.5", bestFor: "restaurants", description: "Restaurant-focused POS.", reviewHref: getPosReviewUrl("toast-pos"), startingPrice: "Quote", standoutFeature: "Restaurant suite" },
];
...
const vendPage: AlternativesTemplateProps = {
  ...squarePage,
  title: "Best Vend POS (Lightspeed Retail) Alternatives (2026)",
  subtitle: "If Vend POS isn't the right fit—because you want the full Lightspeed suite, simpler setup, or different focus—these POS alternatives offer strong options.",
  productName: "Vend POS (Lightspeed Retail)",
  productSlug: "vend-pos",
  originalReviewHref: getPosReviewUrl("vend-pos"),
  quickAnswerParagraphs: [
    "Vend is now part of Lightspeed (Lightspeed Retail); alternatives include Lightspeed POS for the full suite, Square for simplicity and free software, and Shopify for ecommerce. Lightspeed and Square are the main alternatives.",
  ],
  whyPeopleLookForAlternatives: [
    { heading: "Full Lightspeed", body: "Lightspeed POS is the full Lightspeed product; Vend is the retail brand within the family. Some teams prefer the main Lightspeed suite." },
  ...
  comparisonTableRows: buildTableRows(
    { slug: "vend-pos", name: "Vend POS (Lightspeed Retail)", logoSrc: POS_LOGOS.vend, bestFor: "retail; multi-store", startingPrice: "From ~$69/mo", standoutFeature: "Retail; Lightspeed", reviewHref: getPosReviewUrl("vend-pos") },
    VEND_ALTERNATIVES
  ),
  detailedAlternatives: [
    { productName: "Lightspeed POS", heading: "Best for same family", body: "Lightspeed POS is the full Lightspeed suite. For teams that want more modules or the main Lightspeed branding.", reviewHref: getPosReviewUrl("lightspeed-pos"), compareHref: getPosCompareUrl("lightspeed-pos-vs-vend-pos") },
    { productName: "Square POS", heading: "Best for simplicity", body: "Square is simpler and lower cost for single-location or straightforward retail.", reviewHref: getPosReviewUrl("square-pos") },
  ...
  faqItems: [
    { q: "What is the best Vend POS alternative?", a: "Lightspeed POS for the full Lightspeed suite; Square for simplicity and free software; Shopify for ecommerce." },
    { q: "Is Vend the same as Lightspeed?", a: "Vend is now part of Lightspeed (Lightspeed Retail). Lightspeed POS is the main product; Vend is the retail-focused brand in the family." },
...
const TOUCHBISTRO_ALTERNATIVES: AlternativesTopPick[] = [
  { slug: "toast-pos", name: "Toast POS", logoSrc: POS_LOGOS.toast, rating: "4.5", bestFor: "restaurants", description: "Stronger for large or multi-location restaurants.", reviewHref: getPosReviewUrl("toast-pos"), startingPrice: "Quote", standoutFeature: "Restaurant suite" },
  { slug: "square-pos", name: "Square POS", logoSrc: POS_LOGOS.square, rating: "4.6", bestFor: "simplicity", description: "Simpler and cheaper for very simple food service or cafes.", reviewHref: getPosReviewUrl("square-pos"), startingPrice: "Free software", standoutFeature: "Free; simple" },
  { slug: "clover-pos", name: "Clover POS", logoSrc: POS_LOGOS.clover, rating: "4.3", bestFor: "general POS", description: "General-purpose POS with restaurant apps.", reviewHref: getPosReviewUrl("clover-pos"), startingPrice: "From ~$69/mo", standoutFeature: "Hardware; apps" },
  { slug: "lightspeed-pos", name: "Lightspeed POS", logoSrc: POS_LOGOS.lightspeed, rating: "4.4", bestFor: "retail", description: "Retail-focused; less restaurant depth.", reviewHref: getPosReviewUrl("lightspeed-pos"), startingPrice: "From ~$69/mo", standoutFeature: "Retail" },
...
const touchbistroPage: AlternativesTemplateProps = {
  ...
  detailedAlternatives: [
    { productName: "Toast POS", heading: "Best for restaurants", body: "Toast is stronger for large or multi-location restaurants with more comprehensive restaurant suite.", reviewHref: getPosReviewUrl("toast-pos") },
    { productName: "Square POS", heading: "Best for simplicity", body: "Square is simpler and cheaper for very simple food service or cafes.", reviewHref: getPosReviewUrl("square-pos") },
    { productName: "Clover POS", heading: "Best for general POS", body: "Clover is general-purpose with restaurant apps; less depth than TouchBistro for full-service.", reviewHref: getPosReviewUrl("clover-pos") },
    { productName: "Lightspeed POS", heading: "Best for retail", body: "Lightspeed is retail-focused. For businesses that need retail more than restaurant features.", reviewHref: getPosReviewUrl("lightspeed-pos") },
    { productName: "Epos Now", heading: "Best for flexibility", body: "Epos Now offers flexible POS with various integrations.", reviewHref: getPosReviewUrl("epos-now") },
  ],
  relatedComparisons: [],
...
const EPOS_NOW_ALTERNATIVES: AlternativesTopPick[] = [
  { slug: "lightspeed-pos", name: "Lightspeed POS", logoSrc: POS_LOGOS.lightspeed, rating: "4.4", bestFor: "retail", description: "Strong retail with lower entry cost for mid-size.", reviewHref: getPosReviewUrl("lightspeed-pos"), startingPrice: "From ~$69/mo", standoutFeature: "Retail; multi-location" },
  ...
  { slug: "square-pos", name: "Square POS", logoSrc: POS_LOGOS.square, rating: "4.6", bestFor: "simplicity", description: "Simpler setup and free software.", reviewHref: getPosReviewUrl("square-pos"), startingPrice: "Free software", standoutFeature: "Free; simple" },
  { slug: "clover-pos", name: "Clover POS", logoSrc: POS_LOGOS.clover, rating: "4.3", bestFor: "hardware and apps", description: "Wide hardware and app ecosystem.", reviewHref: getPosReviewUrl("clover-pos"), startingPrice: "From ~$69/mo", standoutFeature: "Hardware; apps" },
  { slug: "vend-pos", name: "Vend POS (Lightspeed Retail)", logoSrc: POS_LOGOS.vend, rating: "4.3", bestFor: "retail", description: "Retail-focused; part of Lightspeed.", reviewHref: getPosReviewUrl("vend-pos"), startingPrice: "From ~$69/mo", standoutFeature: "Retail; multi-store" },
];
...
const eposNowPage: AlternativesTemplateProps = {
  ...
  detailedAlternatives: [
    ...
    { productName: "Square POS", heading: "Best for simplicity", body: "Square has simpler setup and free software; stronger brand and support.", reviewHref: getPosReviewUrl("square-pos") },
    { productName: "Clover POS", heading: "Best for hardware and apps", body: "Clover has a wide hardware and app ecosystem.", reviewHref: getPosReviewUrl("clover-pos") },
    { productName: "Vend POS", heading: "Best for retail", body: "Vend (Lightspeed Retail) is retail-focused with multi-store support.", reviewHref: getPosReviewUrl("vend-pos") },
  ],
  relatedComparisons: [],
